({
    init: function (cmp, event, helper) {
      ...
      if(cmp.get('v.mydata_custom4') && cmp.get('v.mydata_custom4').length > 0){
         ...
         if(cmp.get('v.mydata_custom5') && cmp.get('v.mydata_custom5').length > 0){
          cmp.set('v.mydata', cmp.get('v.mydata_custom5'));
           cmp.set('v.obj', 'custom5');
           cmp.set('v.preSelection', cmp.get('v.selectedRows_custom5'));
       }
          if(cmp.get('v.mydata_custom6') && cmp.get('v.mydata_custom6').length > 0){
          cmp.set('v.mydata', cmp.get('v.mydata_custom6'));
           cmp.set('v.obj', 'custom6');
           cmp.set('v.preSelection', cmp.get('v.selectedRows_custom6'));
       }
         if(cmp.get('v.mydata_custom7') && cmp.get('v.mydata_custom7').length > 0){
          cmp.set('v.mydata', cmp.get('v.mydata_custom7'));
           cmp.set('v.obj', 'custom7');
           cmp.set('v.preSelection', cmp.get('v.selectedRows_custom7'));
             }
         if(cmp.get('v.mydata_custom8') && cmp.get('v.mydata_custom8').length > 0){
          cmp.set('v.mydata', cmp.get('v.mydata_custom8'));
           cmp.set('v.obj', 'custom8');
           cmp.set('v.preSelection', cmp.get('v.selectedRows_custom8'));
       }
    ...
    getSelectedName: function (cmp, event) {
        ...
        if(obj == 'standard1'){
         ...
         cmp.set("v.selectedRows_custom5", selectedRows);   
     }
   else if(obj == 'custom6'){
         cmp.set("v.selectedRows_custom6", selectedRows);   
     }
         else if(obj == 'custom7'){
         cmp.set("v.selectedRows_custom7", selectedRows);   
              }
         else if(obj == 'custom8'){
         cmp.set("v.selectedRows_custom8", selectedRows); 
     }
    },
